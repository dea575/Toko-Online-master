...
<div class="container">
    ...
    <div class="mt-4 d-flex justify-content-center">
        <h3><i class="fa fa-plus-square"></i> Tambah Barang</h3>
    </div>
                    ...
                    <form method="POST" action="{{ route('tambah') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3 input-group">
                            <div class="custom-file">
                                ...
                                <input id="gambar" type="file" class="custom-file-input @error('gambar') is-invalid @enderror" name="gambar" value="{{ old('gambar') }}" autofocus>
                              </div>
                            @error('gambar')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
